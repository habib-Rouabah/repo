...
public class ModulesAdapter extends RecyclerView.Adapter<ModulesAdapter.ViewHolder> {
    ...
    private ArrayList<ModuleModel> cat_list;

    ArrayAdapter adapter;
    public ModulesAdapter(ArrayList<ModuleModel> cat_list) {
    ...
    @Override
    public ModulesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ModulesAdapter.ViewHolder viewHolder, int pos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull  View itemView) {
           ...
           editDialog.setContentView(R.layout.edit_module_dialog);
           editDialog.setCancelable(true);
           editDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);


           //adapter = new ArrayAdapter(ModulesActivity.this, android.R.layout.simple_list_item_1,android.R.id.text1,donnees);
        ...
        private void setData(String title,final int pos, final ModulesAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ModuleActivity.selected_cat_index = pos;
            ...
            updateCatB.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        tv_editCatName.setError("Enter Module Name");
                        return;
                    }

                   updateModule(tv_editCatName.getText().toString(), pos, itemView.getContext(), adapter);
        ...
        private void deleteModule(final int id, final Context context, final ModulesAdapter adapter)
        {
            loadingDialog.show();
            ...
            for(int i=0; i < cat_list.size(); i++)
            {
                if( i != id)
                {
                    catDoc.put("MOD" + String.valueOf(index) + "_ID", cat_list.get(i).getId());
                    catDoc.put("MOD" + String.valueOf(index) + "_NAME", cat_list.get(i).getName());
                    index++;
                }
            ...
            firestore.collection("QUIZ").document("Modules")
                    .set(catDoc)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            ModuleActivity.catList.remove(id);
        ...
        private void updateModule(final String catNewName, final int pos, final Context context, final ModulesAdapter adapter)
        {
            editDialog.dismiss();
            loadingDialog.show();
            ...
            firestore.collection("QUIZ").document(cat_list.get(pos).getId())
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Map<String,Object> catDoc = new ArrayMap<>();
                            catDoc.put("MOD" + String.valueOf(pos + 1) + "_NAME",catNewName);
                            ...
                            firestore.collection("QUIZ").document("Modules")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Toast.makeText(context,"Module Name Changed Successfully",Toast.LENGTH_SHORT).show();
                                            ModuleActivity.catList.get(pos).setName(catNewName);
                                            adapter.notifyDataSetChanged();
